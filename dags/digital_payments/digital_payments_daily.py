...
with DAG(
    ...
    def scrape_digital_payments_daily(ds, **context):  
        ...
        try:
            ...
            return f"Downloaded data for: {curr_date.strftime('%d-%m-%Y')}"

        except requests.exceptions.RequestException as e:
            print(e)

    digital_payments_scraping_task = PythonOperator(
    ...
    def process_digital_payments_daily(ds, **context):  
        ...
        try:
            ...
            daily_df.to_csv(os.path.join(data_path, f"digital_payments_{curr_date.strftime('%d-%m-%Y')}.csv"), index=False)
    ...
    digital_payments_processing_task = PythonOperator(
        task_id = 'process_digital_payments_daily',
        python_callable = process_digital_payments_daily,
        depends_on_past=True
    )
    
    digital_payments_scraping_task >> digital_payments_processing_task
